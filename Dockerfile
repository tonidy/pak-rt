...
RUN mkdir -p /tmp/containers \
    && mkdir -p /home/rt-user/.local/share/rt-containers
...
if [[ \$EUID -eq 0 ]]; then
    ...
    echo "💡 You can use: rt create-container webapp --ram=512 --cpu=50"
else
    echo "👤 Running as user - rootless mode"
    echo "💡 You can use: rt --rootless create-container webapp --ram=512 --cpu=50"
fi

echo
echo "📚 Available commands:"
echo "  rt help                           - Show help"
echo "  rt create-container <name>        - Create container"
echo "  rt list-containers                - List all containers"
echo "  rt run-container <name>           - Run container"
echo "  rt delete-container <name>        - Delete container"
